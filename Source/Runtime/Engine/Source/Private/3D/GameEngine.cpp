...
void GameEngine::LoadAsset()
{
	...
	bones = {
		...
		{ GameEngine::index_01_lBone, Bone(GameEngine::index_01_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("index_01_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("index_01_l").Quat)))},
		{ GameEngine::index_02_lBone, Bone(GameEngine::index_02_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("index_02_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("index_02_l").Quat)))},
		{ GameEngine::index_03_lBone, Bone(GameEngine::index_03_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("index_03_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("index_03_l").Quat)))},
		...
		{ GameEngine::middle_01_lBone, Bone(GameEngine::middle_01_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("middle_01_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("middle_01_l").Quat)))},
		{ GameEngine::middle_02_lBone, Bone(GameEngine::middle_02_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("middle_02_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("middle_02_l").Quat)))},
		{ GameEngine::middle_03_lBone, Bone(GameEngine::middle_03_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("middle_03_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("middle_03_l").Quat)))},
		...
		{ GameEngine::pinky_01_lBone, Bone(GameEngine::pinky_01_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("pinky_01_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("pinky_01_l").Quat)))},
		{ GameEngine::pinky_02_lBone, Bone(GameEngine::pinky_02_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("pinky_02_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("pinky_02_l").Quat)))},
		{ GameEngine::pinky_03_lBone, Bone(GameEngine::pinky_03_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("pinky_03_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("pinky_03_l").Quat)))},
		...
		{ GameEngine::ring_01_lBone, Bone(GameEngine::ring_01_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("ring_01_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("ring_01_l").Quat)))},
		{ GameEngine::ring_02_lBone, Bone(GameEngine::ring_02_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("ring_02_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("ring_02_l").Quat)))},
		{ GameEngine::ring_03_lBone, Bone(GameEngine::ring_03_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("ring_03_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("ring_03_l").Quat)))},
		{ GameEngine::thumb_01_lBone, Bone(GameEngine::thumb_01_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("thumb_01_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("thumb_01_l").Quat)))},
		{ GameEngine::thumb_02_lBone, Bone(GameEngine::thumb_02_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("thumb_02_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("thumb_02_l").Quat)))},
		{ GameEngine::thumb_03_lBone, Bone(GameEngine::thumb_03_lBone, Transform(CharacterSkeleton.GetTargetBoneInfo("thumb_03_l").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("thumb_03_l").Quat)))},
		...
		{ GameEngine::pinky_01_rBone, Bone(GameEngine::pinky_01_rBone, Transform(CharacterSkeleton.GetTargetBoneInfo("pinky_01_r").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("pinky_01_r").Quat)))},
		{ GameEngine::pinky_02_rBone, Bone(GameEngine::pinky_02_rBone, Transform(CharacterSkeleton.GetTargetBoneInfo("pinky_02_r").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("pinky_02_r").Quat)))},
		{ GameEngine::pinky_03_rBone, Bone(GameEngine::pinky_03_rBone, Transform(CharacterSkeleton.GetTargetBoneInfo("pinky_03_r").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("pinky_03_r").Quat)))},
		...
		{ GameEngine::ring_01_rBone, Bone(GameEngine::ring_01_rBone, Transform(CharacterSkeleton.GetTargetBoneInfo("ring_01_r").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("ring_01_r").Quat)))},
		{ GameEngine::ring_02_rBone, Bone(GameEngine::ring_02_rBone, Transform(CharacterSkeleton.GetTargetBoneInfo("ring_02_r").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("ring_02_r").Quat)))},
		{ GameEngine::ring_03_rBone, Bone(GameEngine::ring_03_rBone, Transform(CharacterSkeleton.GetTargetBoneInfo("ring_03_r").Transform, Quaternion(CharacterSkeleton.GetTargetBoneInfo("ring_03_r").Quat)))},
